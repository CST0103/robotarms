        ...
        private void RecvDataThread()
        {
            ...
            while (this.IsConnected)
            {
                try
                {
                    if (condition == null)
                    {
                        condition = () => ((!this.IsConnected || (this.tcpSynCl == null)) || ((this.tcpSynCl != null) && !this.tcpSynCl.Connected)) || ((this.tcpSynCl != null) && this.tcpSynCl.Poll(0, SelectMode.SelectRead));
                    }
                    SpinWait.SpinUntil(condition, -1);
                    if (((!this.IsConnected || (this.tcpSynCl == null)) || (!this.tcpSynCl.Connected || (this.tcpSynCl.Available == 0))) || !this.RecvDataFromServer())
                    {
                        break;
                    }
                }
